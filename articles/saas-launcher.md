---
title: "55,000行のSaaSから抽出した Next.js + Firebase + Stripe スターターキットを公開した"
emoji: "🚀"
type: "tech"
...
自分が運用している 55,000行の SaaS（ダーツスコア管理アプリ）から、認証・決済・セキュリティの共通基盤を抽出して汎用化したものです。
...
- 55,000行の本番 SaaS から認証・決済・セキュリティを抽出
- 日本語コード・日本語ドキュメント
- 30分で動く状態になる
- 実運用の知見が反映済み
- ¥2,980
