...
<!-- [🎤 あなたの声] 最初の設計ではコレクション数がもっと少なかった？増えていった過程や、途中で構造を変えた経験があれば -->
...
<!-- [🎤 あなたの声] 非正規化によるデータ不整合が実際に起きた経験、またはバッチで整合性を取り直した話があれば -->
...
<!-- [🎤 あなたの声] セキュリティルールのデバッグで苦労した話。Firebase エミュレータでのテスト体験など -->
